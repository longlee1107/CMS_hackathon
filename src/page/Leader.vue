...
export default {
    ...
    methods: {
        ...
        async approveRequest() {
            try {
                const resp = await timeKeepingService.patchTimeKeeping(this.checkRequest, this.statusChecked.APPROVED);
                this.checkRequest = [];
                this.showRequest();
            }
            catch (error) {
        ...
        async rejectRequest() {
            try {
                const resp = await timeKeepingService.patchTimeKeeping(this.checkRequest, this.statusChecked.REJECTED);
                this.checkRequest=[];
                this.showRequest();
            }
            catch (error) {

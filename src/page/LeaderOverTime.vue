                      ...
                      >
                        ...
                        <td class="px-4 py-3">
                          <div class="flex ml-12 items-center text-center text-sm">
                            ...
                            <div>
                              <p class="text-left font-semibold">{{ request.staff }}</p>
                        ...
                        <td class="px-4 py-3 text-sm text-center">
                          {{ request.time_end | formatHour }} 
                        </td>

                        <td class="px-4 text-center py-3 text-sm" v-if="request.status === 'PENDING'">
                          <input
                            type="checkbox"
                            name=""
                            id=""
...
import CompoLeaderPage from "@/components/CompoLeaderPage.vue";

                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    >
                      ...
                      <td class="px-4 py-3 text-xs">
                        <span
                          class="px-2 py-1 font-semibold leading-tight text-yellow-400 bg-yellow-400 rounded-full dark:bg-yellow-500 dark:text-green-100"
                          v-if="request.status === 'PENDING'"
                        >
                          {{ request.status }}
                        </span>
                        <span
                          class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-700 rounded-full dark:bg-green-700 dark:text-green-100"
